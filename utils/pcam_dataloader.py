...
def get_pcam_loaders(repo_id="allen-ajith/pcam-h5", batch_size=64, num_workers=4, repo_type="dataset", model_type="resnet"):
    """
    ...
    if model_type == "vit":
        ...
        transform_train = transforms.Compose([
            ...
            transforms.ToTensor(),
            transforms.Normalize(mean=imagenet_mean, std=imagenet_std),
            transforms.RandomErasing(p=0.1, scale=(0.02, 0.1), ratio=(0.3, 3.3))  # gentler erasing for ResNet
        ])
